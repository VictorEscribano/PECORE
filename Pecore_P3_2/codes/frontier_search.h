...
public:
   ...
   */
  std::vector<Frontier> searchFrom(geometry_msgs::msg::Point position, geometry_msgs::msg::Point last_goal);
...
protected:
   ...
   * @return new frontier
   */
  Frontier buildNewFrontier(unsigned int initial_cell, geometry_msgs::msg::Point last_goal, std::vector<bool>& frontier_flag);
